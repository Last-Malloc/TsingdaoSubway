...
#include "../../src/QtGuiApplication.h"
...
QT_MOC_LITERAL(1, 17, 18), // "OnLineStartPressed"
QT_MOC_LITERAL(2, 36, 0), // ""
QT_MOC_LITERAL(3, 37, 11), // "LineEndIsOk"
QT_MOC_LITERAL(4, 49, 16), // "OnLineEndPressed"
QT_MOC_LITERAL(5, 66, 18), // "OnLineStartChanged"
QT_MOC_LITERAL(6, 85, 16), // "OnLineEndChanged"
QT_MOC_LITERAL(7, 102, 14), // "OnBtnOKClicked"
QT_MOC_LITERAL(8, 117, 17), // "OnBtnCloseClicked"
QT_MOC_LITERAL(9, 135, 15) // "OnBtnMinClicked"

    },
    "QtGuiApplication\0OnLineStartPressed\0"
    "\0LineEndIsOk\0OnLineEndPressed\0"
    "OnLineStartChanged\0OnLineEndChanged\0"
    "OnBtnOKClicked\0OnBtnCloseClicked\0"
    "OnBtnMinClicked"
};
...
void QtGuiApplication::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: { int _r = _t->OnLineStartPressed();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 1: { int _r = _t->LineEndIsOk();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 2: { int _r = _t->OnLineEndPressed();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 3: { int _r = _t->OnLineStartChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 4: { int _r = _t->OnLineEndChanged();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 5: { int _r = _t->OnBtnOKClicked();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 6: { int _r = _t->OnBtnCloseClicked();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        case 7: { int _r = _t->OnBtnMinClicked();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = std::move(_r); }  break;
        default: ;
        }
    }
...
QT_INIT_METAOBJECT const QMetaObject QtGuiApplication::staticMetaObject = {
